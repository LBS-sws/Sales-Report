...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('pesttype','pesttype Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
        ...
        ?>
        <?php if($model->id){ echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array( 'submit'=>Yii::app()->createUrl('pesttype/delete'))
        );}
        ?>
	</div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->textField($model, 'type_name',
                        array('size'=>40,'maxlength'=>250,"id"=>"type_name",'readonly'=>false)
                    ); ?>
                </div>
