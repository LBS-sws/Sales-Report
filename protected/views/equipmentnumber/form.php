...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('equipment','Equipmentnumber Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		...
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('equipmentnumber/index')));
		?>
        <?php
        echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
            'submit'=>Yii::app()->createUrl('equipmentnumber/save')));
        ?>
        <?php if($model->id){ echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array( 'submit'=>Yii::app()->createUrl('equipmentnumber/delete'))
        );}
        ?>
	</div>
    ...
    <div class="box box-info" style=" padding-bottom: 10px;">
        <div class="box-body">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model,'eq_type_id',array('class'=>"col-sm-2 control-label")); ?>
                <div class="col-sm-2">
                    <?php
                    echo $form->dropDownList($model, 'eq_type_id', $equipment_types);
                    ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->numberField($model, 'number',
                        array('size'=>40,'maxlength'=>250,"id"=>"number",'readonly'=>false)
                    ); ?>
                </div>
            </div>
        </div>
