...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('risk','Risktype Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('risktype/index')));
		?>
        <?php
        echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
            'submit'=>Yii::app()->createUrl('risktype/save')));
        ?>
        <?php if($model->id){ echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array( 'submit'=>Yii::app()->createUrl('risktype/delete'))
        );}
        ?>
	</div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->textField($model, 'type',
                        array('size'=>40,'maxlength'=>250,"id"=>"type",'readonly'=>false)
                    ); ?>
                </div>
            </div>
        </div>
