...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('risk','Riskpest Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		...
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('riskpest/index')));
		?>
        <?php
        echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
            'submit'=>Yii::app()->createUrl('riskpest/save')));
        ?>
        <?php if($model->id){ echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array( 'submit'=>Yii::app()->createUrl('riskpest/delete'))
        );}
        ?>
	</div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->textField($model, 'target',
                        array('size'=>40,'maxlength'=>250,"id"=>"target",'readonly'=>false)
                    ); ?>
                </div>
            </div>
        </div>
